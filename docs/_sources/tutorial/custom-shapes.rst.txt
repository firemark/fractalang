...
.. tut:animation:: The Cloud
   ...
   H@ROTATE_RIGHT, H@ANGLE_180, H@CALL_H      # Rotate and call themself with an argument.
   G@ROTATE_RIGHT, G@ANGLE_180, G@DRAW_ARCLINE_L_1_4  # Then, draw the bottom of the figure.
   G@ROTATE_RIGHT, G@ANGLE_90, G@CALL_H       # Call the "H" stave again.
   G@ROTATE_RIGHT, G@ANGLE_180, G@DRAW_ARCLINE_L_1_4  # Close the figure.
